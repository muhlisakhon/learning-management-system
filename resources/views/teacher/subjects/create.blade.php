    ...
    <div class="max-w-5xl mx-auto p-6 space-y-8">
        <div class="bg-white rounded-xl shadow-sm p-6 space-y-6">
            ...
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-indigo-600 mb-2">📖 Create New Subject</h1>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                            Subject Name <span class="text-indigo-600" title="Required field">★</span>
                        </label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                            Subject Code <span class="text-indigo-600" title="Required field">★</span>
                        </label>
                        <input type="text" name="code" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500"
                               placeholder="e.g. IK-ABC123"
                               value="{{ old('code') }}">
                        @error('code')
                            <p class="mt-1 text-sm text-red-600 bg-red-50 p-2 rounded-lg">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                            Credit Value <span class="text-indigo-600" title="Required field">★</span>
                        </label>
